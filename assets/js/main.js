$(document).ready(function() {
    ...
    map.addMarker({
        ...
        infoWindow: {
            content: '<div class="note">Ceremonia & Recepción</div><h4 class="map-title script">Restaurante y Galería Mailia</h4><div class="address"><span class="region">Cra. 48 No. 74 - 71</span><br><span class="city-name">Barranquilla </span></div>'
        }
...
/*
    ...
    var feed = new Instafeed({
            limit: 28,
            get: 'tagged',
            tagName: 'marieyfabian2015', /* Remember to use a unique hastag for the wedding */
            clientId: "112667b84fda46f1b16fdfa58d3d6888", /* IMPORTANT: REPLACE THE DEMO CLIENTID WITH YOUR CLIENTID! Find out your clientID: http://darkwhispering.com/how-to/get-a-instagram-client_id-key */
